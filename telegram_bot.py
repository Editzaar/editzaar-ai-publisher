...
TELEGRAM_BOT_TOKEN = os.environ.get(TELEGRAM_BOT_TOKEN, 8747123023:AAHvZb_kgwq-i1HqGgtCkXSElC8GJG10Ngo)
BASE_TELEGRAM_URL = fhttps://api.telegram.org/bot{TELEGRAM_BOT_TOKEN}
...
def send_telegram_message(chat_id, text, parse_mode=HTML):
    try:
        ...
        print(fError sending Telegram message: {e}, flush=True)
...
def send_telegram_photo_bytes(chat_id, photo_bytes, caption="):
 ...
 print(fError sending direct photo to Telegram: {e}, flush=True)
